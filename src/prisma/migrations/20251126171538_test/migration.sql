...
-- CreateEnum
CREATE TYPE "UserRoleEnum" AS ENUM ('SuperAdmin', 'admin', 'supervisor', 'driver', 'passenger');
...
CREATE TABLE "users" (
    "id" UUID NOT NULL,
    "tenant_id" UUID NOT NULL,
    "role" "UserRoleEnum" NOT NULL DEFAULT 'passenger',
    "name" VARCHAR(150),
    "email" VARCHAR(150),
...
CREATE TABLE "bus_status_logs" (
    "id" BIGSERIAL NOT NULL,
    "bus_id" UUID NOT NULL,
    "status" "BusOperationStatus" NOT NULL,
    "timestamp" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
